...
public class LogRequestDispatcher {
	...
	LogRequestDispatcher(String fileName, String fileContent) {
		inputParams = new LogParameters(fileName, fileContent);
	}
	...
	public void run() {
		...
		for (int i = 0; i < nList.getLength(); i++) {
			try {
				...
				String hostPort = String.valueOf(2061);
	...
	public void sendMessage(LogParameters params) {
		try {
